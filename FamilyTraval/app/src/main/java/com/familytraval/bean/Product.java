...
//  规格类型
    ...
    //  商品属性
    private List<ProductAttribute> attrArr;
...
//order_id 订单ID
    ...
    public void setAttrArr(List<ProductAttribute> attrArr) {
    ...
    public String getImageThumlUrl() {
        return SPCommonUtils.getThumbnail(MobileConstants.FLEXIBLE_THUMBNAIL, this.goodsID);
