...
public class NfcDispatcher {
	...
	public static NfcAdapter  getNfcAdapter(Activity mActivity){
		if(mAdapter == null){
	...
	public static void enableDispatch(Activity mActivity,Intent intent,IntentFilter[] filters, String[][] techLists){
		...
		getNfcAdapter(mActivity).enableForegroundDispatch(mActivity, mPendingIntent, filters,techLists);
	}
	
	public static void disableDispatch(Activity mActivity) {
		getNfcAdapter(mActivity).disableForegroundDispatch(mActivity);
	}
}
