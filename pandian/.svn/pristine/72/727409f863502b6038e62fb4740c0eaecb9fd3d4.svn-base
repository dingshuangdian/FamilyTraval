...
public abstract class ResultHandler {
  ...
  final void shareByEmail(String contents) {
    sendEmailFromUri("mailto:", null, "Here are the contents of a barcode I scanned",
        contents);
  }
  ...
  final void shareBySMS(String contents) {
    sendSMSFromUri("smsto:", "Here are the contents of a barcode I scanned" + ":\n" +
        contents);
  }
  ...
  final void launchIntent(Intent intent) {
    try {
      ...
      builder.setMessage("抱歉，请求的应用可能没有运行，或者是条码错误");
